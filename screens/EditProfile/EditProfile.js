...
const EditProfile = ({route, navigation}) => {
  ...
  const EditProfileApi = async apiData => {
    ...
    try {
      ...
      console.log('EditProfileApi', response);
    } catch (error) {
      setLoader(false);
  ...
  const getProfileApi = async () => {
    setLoader(true);
    let payload = {
      user_mobile_number: userProfile.user_mobile_number,
    };
    console.log('getProfileApi', payload);
    try {
      ...
      {loader == true ? (
        ...
        <View style={{flex: 1}}>
          ...
          <View
            ...
            {Object.values(userAllDetails).includes('user_image') ? (
              <Image
                source={{
                  uri: `data:image/jpeg;base64, ${userAllDetails.user_image}`,
                }}
              ...
              <Image source={{uri: localImage}} style={styles.profile} />
            ) : (
              <Image
                source={require('../../Assets/images/banner/user.png')}
                style={styles.profile}
                ...
                <View style={{flexDirection: 'row', marginBottom: 15}}>
                  <LinearGradient
                    ...
                    style={[
                      ...
                      {minWidth: '40%', justifyContent: 'space-between'},
                    ]}>
                    <TouchableOpacity
                      onPress={() => {
                        pickImage();
            ...
            initialValues={{
              ...
              lastName:
                userProfile && userProfile.last_name
                  ...
                  : '',
              email:
                userProfile && userProfile.user_email
                  ? userProfile.user_email
                  : '',
              mobileNumber:
                userProfile && userProfile.user_mobile_number
                  ? userProfile.user_mobile_number.toString()
                  : '',
            }}
            onSubmit={values => {
              if (values) {
                let imagePth = image ? image : '';
                let apiData = {
            ...
            {({
              ...
              <View>
                ...
                <GlobalButton
                  ...
                  inlineStyle={{marginRight: 20, marginTop: 20}}
                />
              </View>
            )}
          </Formik>
